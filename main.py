...
class SuperChatApp(MDApp):
    def build(self):
        ...
        self.avatar = Image(id="avatar", size_hint=(None, None), size=(Window.size[0]*0.65, Window.size[0]*0.55), source="icon.png")
        self.anchor = AnchorLayout(anchor_x="center", size_hint_y=None, height=self.avatar.height*1.3)
